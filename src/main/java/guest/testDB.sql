...
altter table insarok drop column netpay;
...
select name as 성명, gender '성별', jikwi, address '주소' from insarok;
...
select name as '성명', age as '성별', gender as'성별', age as '나이', address as '주소' from insarok;
