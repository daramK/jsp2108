...
insert into guest values (default,'관리자', 'admin@naver.com', 'blog/admin', default, '192.168.0.1', '방명록 서비스를 시작합니다.');
insert into guest values (default,'홍길동', 'hdk1234@daum.net', '', default, '192.168.0.10', '잠시 방문해 봅니다.');
